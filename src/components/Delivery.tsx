...
const features: FeatureProps[] = [
    ...
    },
    {
        ...
        description:
            'El pedido tarda en llegar entre 4 y 5 días, los gastos de envío están incluidos en el precio 😇',
    },
    {
        image: collaboration,
    ...
    return (
        ...
        >
            ...
            <p className="md:w-3/4 mx-auto mt-4 mb-8 text-xl text-muted-foreground">
                Si después de ver los{' '}
                <a className="underline" href="#examples">
                    ejemplos disponibles
                </a>{' '}
                te interesa comprarlos, este es el proceso que has de seguir para tenerlos en casa.
            </p>
