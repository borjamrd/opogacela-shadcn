      ...
      <div className="grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-xl text-muted-foreground">
            Te ofrezco varias opciones de pago para hacer el trámite lo más
            fiable y rápido posible. Recuerda que tienes la opción de pagarlo
            con 0% de intereses mediante Klarna.
          </p>
        </div>
      </div>
    </section>
