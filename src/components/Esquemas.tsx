...
async function loadPrices() {
    ...
    const gacePrices = allPrices.filter((price) => price.metadata?.type === 'gace');
    const adminPrices = allPrices.filter((price) => price.metadata?.type === 'admin');
        ...
        <div>
            <section id="esquemas" className="container py-24 sm:py-32">
                ...
                <h3 className="text-xl text-center text-muted-foreground py-4">
                    Puedes escoger uno o varios bloques, recuerda que la compra se realizará en otra
