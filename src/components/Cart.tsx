    ...
    return <AlertDialog>
        ...
        <AlertDialogContent className="max-w-5xl">
            <AlertDialogHeader>
                ...
                <div className="flex flex-col text-start gap-2">
                    {prices.map((pricing) =>
                        ...
                        <div key={pricing.id} className='flex flex-col lg:flex-row lg:gap-2 gap-8 p-3 rounded-lg border bg-card text-card-foreground shadow-sm'>
            ...
            <AlertDialogFooter>
                ...
                {prices.length > 0 && <AlertDialogAction onClick={checkout}>Continuar</AlertDialogAction>}
