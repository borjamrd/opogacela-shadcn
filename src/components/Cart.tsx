    ...
    return (
        <AlertDialog open={isCartOpen} onOpenChange={setCartOpen}>
            <AlertDialogTrigger asChild>
                ...
                >
                    {prices.length > 0 && (
                        <Badge className="absolute -top-2 -right-2 z-10 ">{prices.length}</Badge>
                    )}
            ...
            <AlertDialogContent className="max-w-5xl">
                ...
                <div className="flex flex-col lg:flex-row gap-4 my-4">
                    ...
                    >
                        ...
                        <span className="text-sm">Entre 1 y 2 días hábiles (+3.5€)</span>
                    </Button>
                </div>
                <div className="rounded bg-red-50 text-red-900 text-xs p-3 flex flex-col gap-2">
                    <span>
                        ...
                        recomendamos la impresión previa de uno de nuestros ejemplos para comprobar
                        que estás cómodo con su lectura. No se hacen devoluciones de material salvo
                        error en impresión o encuadernación.
                    </span>
